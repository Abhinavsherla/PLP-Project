...
function getMockFallback() {
  const mockRaw = [
    ...
    { id: 4, title: "Mens Casual Slim Fit", price: 15.99, description: "The color could be slightly different between on the screen and in practice.", category: "men's clothing", image: "https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?auto=format&fit=crop&q=80&w=800", rating: { rate: 2.1, count: 430 } },
    ...
    { id: 9, title: "WD 2TB Elements Portable External Hard Drive", price: 64, description: "USB 3.0 and USB 2.0 Compatibility Fast data transfers.", category: "electronics", image: "https://images.unsplash.com/photo-1563207153-f403bf289096?auto=format&fit=crop&q=80&w=800", rating: { rate: 3.3, count: 203 } },
    { id: 10, title: "SanDisk SSD PLUS 1TB Internal SSD", price: 109, description: "Easy upgrade for faster boot up, shutdown, application load.", category: "electronics", image: "https://images.unsplash.com/photo-1591799272330-8be7ea52494a?auto=format&fit=crop&q=80&w=800", rating: { rate: 2.9, count: 470 } },
