...
function getMockFallback() {
  const mockRaw = [
    ...
    { id: 9, title: "WD 2TB Elements Portable External Hard Drive", price: 64, description: "USB 3.0 and USB 2.0 Compatibility Fast data transfers.", category: "electronics", image: "https://images.unsplash.com/photo-1544244015-0cd4b3ffc6b0?q=80&w=800&cb=final", rating: { rate: 3.3, count: 203 } },
    { id: 10, title: "SanDisk SSD PLUS 1TB Internal SSD", price: 109, description: "Easy upgrade for faster boot up, shutdown, application load.", category: "electronics", image: "https://images.unsplash.com/photo-1597872200310-7662c2f444c1?q=80&w=800&cb=final", rating: { rate: 2.9, count: 470 } },
