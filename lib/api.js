...
function getMockFallback() {
  const mockRaw = [
    ...
    { id: 9, title: "Logitech MX Master 3S Performance Wireless Mouse", price: 99, description: "Advanced wireless mouse for high-performance work and ultra-fast scrolling.", category: "electronics", image: "https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=800", rating: { rate: 4.8, count: 500 } },
    { id: 10, title: "High-Performance Dual-Band AC1200 WiFi Router", price: 89, description: "Stable and fast internet connection for gaming and streaming.", category: "electronics", image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800", rating: { rate: 4.5, count: 320 } },
