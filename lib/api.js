...
function getMockFallback() {
  const mockRaw = [
    ...
    { id: 10, title: "SanDisk SSD PLUS 1TB Internal SSD", price: 109, description: "Easy upgrade for faster boot up, shutdown, application load.", category: "electronics", image: "https://images.unsplash.com/photo-1599673081169-af4465bc7200?w=800", rating: { rate: 2.9, count: 470 } },
