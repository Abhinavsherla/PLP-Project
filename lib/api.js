...
function getMockFallback() {
  const mockRaw = [
    ...
    { id: 9, title: "WD 2TB Elements Portable External Hard Drive", price: 64, description: "USB 3.0 and USB 2.0 Compatibility Fast data transfers.", category: "electronics", image: "https://images.unsplash.com/photo-1531297484001-80022d31dfc9?w=800", rating: { rate: 3.3, count: 203 } },
